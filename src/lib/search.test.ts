...
describe("searchInContent", () => {
  ...
  it("is case insensitive", () => {
    const index: ContentIndex = new Map([["/vault/note.md", "Hello World"]]);
  ...
  it("returns empty array when query is empty", () => {
    const index: ContentIndex = new Map([["/vault/note.md", "Some content"]]);
...
describe("combinedSearch", () => {
  it("returns title matches first, then content matches", () => {
    ...
    expect(result).toEqual(["/vault/Meeting Notes.md", "/vault/Project.md"]);
  });
