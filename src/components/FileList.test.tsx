...
describe("FileList", () => {
      ...
      mockListFolderResponse([
        {
          ...
          name: "note.md",
          path_lower: "/note.md",
          path_display: "/note.md",
          id: "id:1",
        },
        {
          ".tag": "file",
          name: "another.md",
          path_lower: "/another.md",
          path_display: "/another.md",
          id: "id:2",
        },
      ]),
    );
  ...
  it("shows empty state when no markdown files and no folders", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("No markdown files found in vault."),
      ).toBeInTheDocument();
    });
  });
      ...
      mockListFolderResponse([
        {
          ".tag": "file",
          name: "visible.md",
          path_lower: "/visible.md",
          path_display: "/Vault/visible.md",
          id: "id:1",
        },
        {
          ".tag": "file",
          name: ".hidden.md",
          path_lower: "/.hidden.md",
          path_display: "/Vault/.hidden.md",
          id: "id:2",
        },
        {
          ".tag": "folder",
